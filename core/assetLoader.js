...
async function loadSbluerAssets() {
  ...
  spit: await loadOrNull('src/sbluer/sbluer_spit.piskel'),//este es el personaje escupiendo, que es un ataque especial registrado en registerSpecialsForChar con la secuencia G,P
  spitProj: await loadOrNull('src/sbluer/sbluer_spit_proj.piskel'),//este es el proyectil del ataque de escupitajo, que es un ataque especial registrado en registerSpecialsForChar con la secuencia G,P
  };
}
